      ...
      {books && (
        <div className="lg:fixed bottom-0 left-0 right-0 text-2xl text-orange-300 font-bold antiqua px-5">
          ...
          <div className="flex justify-start text-orange-300 font-light">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-8 xl:grid-cols-12 gap-2 text-white md:text-xs mb-3">
              {books.map((book) => (
                <div
                ...
                >
                  <button
                    ...
                    className=" z-30 text-white right-0 top-0 absolute hover:bg-pink-700 rounded-tr-lg rounded-md"
                  >
                    <TrashIcon className="h-6 w-6 m-1 text-gray-400 hover:text-white " />
                  </button>
                  <div className=" hover:bg-[url('../../public/background3.png')] bg-cover relative w-[100vw] aspect-square border-4 border-[#15161b] hover:border-4 hover:border-sky-900 rounded-r-xl flex items-center">
