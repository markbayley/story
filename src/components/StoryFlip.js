...
<>
{/* <button onClick={() =>
        book.current.pageFlip().flipPrev()}>Prev</button>
      <button onClick={() =>
        book.current.pageFlip().flipNext()}>Next</button> */}
      <HTMLFlipBook autoSize="true" width={1000} height={700}  onFlip={onFlip}>
        <ImagePage number="0"></ImagePage>
        <ImagePage number="1"></ImagePage>
        <ImagePage number="2"></ImagePage>
        <ImagePage number="3"></ImagePage>
        <ImagePage number="4"></ImagePage>
        <ImagePage number="5"></ImagePage>
      </HTMLFlipBook>
    ...
    return (
      ...
      <div className="w-full h-full sm:w-1/2 sm:pb-4 flex-1 lg:pt-2 lg:ml-2">
        <div className="m-4 sm:rounded-tl-xl sm:rounded-bl-xl">
          ...
          <div
          className="flex flex-col w-full sm:w-1/2 pl-4 lg:pl-6 sm:pt-6 pr-4 pb-6  
          sm:rounded lg:rounded-xl  sm:rounded-tr-lg sm:rounded-br-lg sm:border-l-4 sm:border-stone-700 ... overflow-y-hidden text-stone-900 antiqua"
        >
  ...
  return (
    <>
      <div className="fade-in sm:mt-4 ">
        ...
        >
          <div className="sm:border-r-2 sm:border-l-1 sm:rounded-xl sm:border-stone-800 mx-auto sm:flex  border">
            <MyBook />
            {/* <ImagePage />
            <TextPage /> */}
               {/* <PageControls /> */}
